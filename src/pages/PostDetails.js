  ...
  return (
    <React.Fragment>
      <BodyContainer>
        ...
        <Image paddingTop="40%" shape="rectangle" src={this_post.image} backgroundSize="contain" />
        ...
        {is_login? 
          this_post.nickname === userInfo.nickname? (
            <Grid center="center">
              <Button width="64px" margin="0 8px 0" display="inline"
                onClick={() => history.push(`/write/${this_post.postId}`)}
              >
                수정하기
              </Button>
              <Button width="64px" display="inline" onClick={deletePost}>삭제하기</Button>
            </Grid>
          ):null
          : null}
